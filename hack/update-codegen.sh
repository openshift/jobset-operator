...
# 1. copy paste pkg/apis/openshiftoperator/v1/types_jobsetoperator.go under github.com/openshift/api/ under operator/v1 directory (and update the file to remove the cyclic dependency)
...
kube::codegen::gen_client \
    ...
    --output-pkg "github.com/openshift/jobset-operator/pkg/generated" \
