...
func RunOperator(ctx context.Context, cc *controllercmd.ControllerContext) error {
	...
	staticResourceController := staticresourcecontroller.NewStaticResourceController(
		...
		[]string{
			...
			"assets/jobset-controller-generated/rbac.authorization.k8s.io_v1_role_jobset-manager-secrets-role.yaml",
			"assets/jobset-controller-generated/rbac.authorization.k8s.io_v1_rolebinding_jobset-leader-election-rolebinding.yaml",
			"assets/jobset-controller-generated/rbac.authorization.k8s.io_v1_rolebinding_jobset-manager-secrets-rolebinding.yaml",
			"assets/jobset-controller-generated/v1_service_jobset-controller-manager-metrics-service.yaml",
		"assets/jobset-controller/networkpolicy-allow-operator.yaml",
		"assets/jobset-controller/networkpolicy-allow-operand.yaml",
		"assets/jobset-controller/networkpolicy-default-deny.yaml",
		},
